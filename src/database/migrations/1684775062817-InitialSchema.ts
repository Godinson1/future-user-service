...
export class InitialSchema1684775062817 implements MigrationInterface {
  name = 'InitialSchema1684775062817';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "external_providers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP NOT NULL DEFAULT now(), "ws_endpoint" text NOT NULL, "provider_name" text, CONSTRAINT "PK_2a3004dabee1867421a30488279" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
